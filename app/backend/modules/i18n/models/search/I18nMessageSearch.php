...
class I18nMessageSearch extends I18nMessage
{
    ...
    {
        $query = I18nMessage::find()->where([ 'language' => \Yii::$app->language ])->with('sourceMessageModel')->joinWith('sourceMessageModel');
        ...
        // TODO (Pol) uncomment whenever we a single category (define here).
        //$query->andFilterWhere([
        //    '{{%i18n_source_message}}.category' => 'med',
        // ]);
        ...
        $query->andFilterWhere([ 'like', '{{%i18n_message}}.language', $this->language ])
            ->andFilterWhere([ 'like', '{{%i18n_source_message}}.translation', $this->translation ])
