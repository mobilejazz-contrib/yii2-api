...
class Submitter extends Widget
{
    ...
    public function init()
    {
        ...
        if ($this->displayCancel)
        {
            ...
            {
                echo Html::a('<i class="fa fa-times icon-margin small"></i> ' . Yii::t('backend', 'Cancel'), $this->returnUrl, [ 'class' => 'btn btn-default' ]);
            }
        ...
        if ($this->displaySave)
        {
            if ($this->model->isNewRecord)
            {
                echo Html::submitButton(
                    '<span class="fa fa-check icon-margin small"></span> ' . Yii::t('backend', 'Create'),
                    [ 'class' => 'btn btn-success pull-right' ]);
            }
            else
            {
                echo Html::submitButton(
                    '<span class="fa fa-refresh icon-margin small"></span> ' . Yii::t('backend', 'Update'),
                    [ 'class' => 'btn btn-success pull-right' ]);
            }
        }
